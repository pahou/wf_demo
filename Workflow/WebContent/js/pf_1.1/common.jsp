...
<script type="text/javascript" src="<%=contextPath %>/js/pf_1.1/jquery.easyui.min.js"></script>
		...
		if ("true" == hasForm) {
			...
			for (var i = 0; i < fjson.length; i++) {
				...
				if (!lazy) {
					...
					createForm(span, fid, method, fields, dataUrl,null,null,lazy,text,showText);
