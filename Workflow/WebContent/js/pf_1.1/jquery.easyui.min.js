...
}).bind("click.datagrid", function(e){/*2015-03-12 jqm*/
var field = $(this).attr("field");
opts.onHeaderClickCell.call(_501,e,field);
}).bind("dblclick.datagrid", function(e){/*2015-03-12 jqm*/
	var field = $(this).attr("field");
	opts.onHeaderDblClickCell.call(_501,e,field);
	});
...
//@是否初始加载
var isload = _5e8==null?true:false;
var opts;
if(_5e8){
...
$.ajax({type:opts.method,url:opts.url,data:_697,dataType:"json",success:function(data){
	...
	col = opts.columns[0];
	if(col){
		for(var d=0;d<tempdata.length;d++){
			tempcol = {};
			for(var i=0;i<col.length;i++){
        		var field = col[i].field;
        		var keyarr = field.split(".");
        		if(keyarr.length==1){
        			tempcol[field] = tempdata[d][field];
        		}else if(keyarr.length>1){
        			var tempvalue = tempdata[d];
        			for(var j=0;j<keyarr.length;j++){
        				if(tempvalue==null){
        					break;
        				}
        				tempvalue = tempvalue[keyarr[j]];
        			}
        			tempcol[field] = tempvalue;
        		}
        	}
			temprows.push(tempcol);
    	}
		delete data[data];
    	data.rows = temprows;
	}
...
},onHeaderClickCell:function(e,field){
},onHeaderDblClickCell:function(e,field){
