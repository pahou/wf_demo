...
draw2d.Draggable.prototype.construct = function(_6051) {
	...
	var _6056 = function() {	//..
		...
		if (oThis.node !== null){
			...
			if(oThis.node.getWorkflow() == null) return false;
...
draw2d.Figure.prototype.setWorkflow = function(_59c7) {
	if (this.draggable === null) {
		...
		this.tmpDragstart = function(_59ce) {
			...
			_59ce.preventDefault = oThis.onDragstart(_59ce.x, _59ce.y);
		};
...
draw2d.Line = function() {
	...
	this.canvas = null;
	this.parent = null;
	this.isExpression = false;	//自定义属性，判断是否需要表达式
	this.conditionValue = null;	//自定义属性
	this.workflow = null;
	this.html = null;
	this.graphics = null;
	this.id = draw2d.UUID.create();
