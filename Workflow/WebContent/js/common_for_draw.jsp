...
<link type="text/css"
	href="<%=contextPath%>/js/processdesigner/jquery-easyui/themes/gray/easyui.css"
	rel="stylesheet"/>
<!-- JQuery-->
...
<link href="<%=contextPath%>/js/processdesigner/jquery-easyui/themes/icon.css" type="text/css" rel="stylesheet" />
</head>
