...
/**
 * SampleBm2 entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "SAMPLE_BM2")
public class SampleBm2 extends BaseEntity<Integer> {
	...
	/** minimal constructor */
	public SampleBm2(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public SampleBm2(Integer id, String bh, String fbh, String mc,
